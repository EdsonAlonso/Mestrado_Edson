import numpy as np
from Mestrado.EquivalentLayer.Utils.Spherical import distance
from Mestrado.EquivalentLayer.Utils.Mag import magnetization, delta_mag
...
#     d = Dipole( 6371, np.radians(90), np.radians(0),np.radians(0), np.radians(0), 1 )
#
#     h = 5
#     nobs = 50
...
#     print( time( ) - t1 )
#
#     from Mestrado.SHToolsTests.Plots import PlotMag
#     PlotMag( np.reshape( B_r , (nobs,nobs) ), 'Campo Total', 'B', show = True, save = False )
