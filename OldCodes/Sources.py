from Mestrado.OldCodes.Utils.Conversions import Spherical2Cartesian, Carterian2Spherical
from Mestrado.OldCodes.Utils.Magnetic import magnetic_moment
from Mestrado.OldCodes.Utils.Spherical import unit_spherical_vectors
